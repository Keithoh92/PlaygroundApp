package com.example.playground.expensesactivity.contract
...
interface ExpensesActivityContract {
    ...
    sealed class ExpensesActivityEvent {
        ...
        data object FetchDataFromThisActivityUsingInteractor : ExpensesActivityEvent()
        data object FetchDataFromThisActivityUsingCallback : ExpensesActivityEvent()
        data class DataFetchedFromThisActivityUsingInteractor(val data: String?) : ExpensesActivityEvent()
